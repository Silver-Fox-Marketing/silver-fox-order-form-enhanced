#!/usr/bin/env python3
"""
Suntrupkiasouth Optimized Scraper
===================================
...
class SuntrupKiaSouthOptimizedScraper:
    """Production-optimized scraper for Suntrup Kia South"""
    
    def __init__(self):
        self.base_url = "https://www.suntrupkiasouth.com"
...
def test_scraper():
    ...
    scraper = SuntrupKiaSouthOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Suntrupkiasouth")
    return vehicles
