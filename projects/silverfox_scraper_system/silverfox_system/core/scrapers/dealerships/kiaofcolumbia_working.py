...
class KiaofcolumbiaWorkingScraper:
    """Scraper for Kia of Columbia"""
    
    def __init__(self):
        self.base_url = "https://www.kiaofcolumbia.com"
        self.dealer_name = "Kia of Columbia"
...
def test_scraper():
    ...
    scraper = KiaofcolumbiaWorkingScraper()
