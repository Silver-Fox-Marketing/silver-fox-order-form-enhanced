#!/usr/bin/env python3
"""
Rusty Drewing Cadillac Scraper
==============================
...
class RustydrewingcadillacWorkingScraper:
    """Scraper for Rusty Drewing Cadillac"""
    
    def __init__(self):
        self.base_url = "https://www.rustydrewingcadillac.com"
        self.dealer_name = "Rusty Drewing Cadillac"
...
def test_scraper():
    ...
    scraper = RustydrewingcadillacWorkingScraper()
