...
class ColumbiabmwOriginalScraper:
    """Original scraper for Columbiabmw"""
    
    def __init__(self):
        self.base_url = "https://columbiabmw.com"
        self.dealer_name = "Columbiabmw"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}columbiabmw_vehicles.json"
...
def test_scraper():
    ...
    scraper = ColumbiabmwOriginalScraper()
