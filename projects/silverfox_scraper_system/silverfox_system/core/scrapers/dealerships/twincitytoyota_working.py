...
class TwincitytoyotaWorkingScraper:
    """Scraper for Twin City Toyota"""
    
    def __init__(self):
        self.base_url = "https://www.twincitytoyota.com"
        self.dealer_name = "Twin City Toyota"
...
def test_scraper():
    ...
    scraper = TwincitytoyotaWorkingScraper()
