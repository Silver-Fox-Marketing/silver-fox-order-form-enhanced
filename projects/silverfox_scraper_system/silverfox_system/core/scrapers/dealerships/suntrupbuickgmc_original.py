#!/usr/bin/env python3
"""
Suntrupbuickgmc Original Scraper
=============================================
...
class SuntrupbuickgmcOriginalScraper:
    """Original scraper for Suntrupbuickgmc"""
    
    def __init__(self):
        self.base_url = "https://suntrupbuickgmc.com"
        self.dealer_name = "Suntrupbuickgmc"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}suntrupbuickgmc_vehicles.json"
...
def test_scraper():
    ...
    scraper = SuntrupbuickgmcOriginalScraper()
...
# 		street_addr = '4200 N SERVICE RD'
# 		locality = "SAINT PETERS"
# 		postal_code = '63376'
# 		region = 'MO'
# 		country = 'US'
# 		location = 'Suntrup Buick GMC'
...
# 
# 			
# 	def start_scraping_suntrupbuickgmc(self):
# 
...
# 
# 		soup = self.helper.make_soup_url('https://www.suntrupbuickgmc.com/searchall.aspx?Dealership=Suntrup%20Buick%20GMC')
...
# 		while 1:
# 
# 			url = f'https://www.suntrupbuickgmc.com/api/vhcliaa/vehicle-pages/cosmos/srp/vehicles/{dealer_id}/{page_id}?pt={page_num}'
# 			url += f'&Dealership=Suntrup%20Buick%20GMC&host=www.suntrupbuickgmc.com&pn=12&displayCardsShown={display_cards}'
# 
