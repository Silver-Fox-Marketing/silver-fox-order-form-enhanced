...
class SuntrupbuickgmcWorkingScraper:
    """Scraper for Suntrup Buick GMC"""
    
    def __init__(self):
        self.base_url = "https://www.suntrupbuickgmc.com"
        self.dealer_name = "Suntrup Buick GMC"
...
def test_scraper():
    ...
    scraper = SuntrupbuickgmcWorkingScraper()
