#!/usr/bin/env python3
"""
Joemachenscdjr Optimized Scraper
===================================
...
class JoeMachensChryslerDodgeJeepRamOptimizedScraper:
    """Production-optimized scraper for Joe Machens Chrysler Dodge Jeep Ram"""
    
    def __init__(self):
        self.base_url = "https://www.joemachenscdjr.com"
...
def test_scraper():
    ...
    scraper = JoeMachensChryslerDodgeJeepRamOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Joemachenscdjr")
    return vehicles
