#!/usr/bin/env python3
"""
Davesinclairlincolnstpeters Optimized Scraper
===================================
...
class DaveSinclairLincolnStPetersOptimizedScraper:
    """Production-optimized scraper for Dave Sinclair Lincoln St. Peters"""
    
    def __init__(self):
        self.base_url = "https://www.davesinclairlincolnstpeters.com"
        self.dealer_name = "Davesinclairlincolnstpeters"
        ...
        self.expected_inventory_range = (25, 75)
    ...
    def get_all_vehicles(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if api_vehicles and len(api_vehicles) >= 25:
    ...
    def _get_vehicles_via_api(self) -> List[Dict[str, Any]]:
        """Get vehicles via DealerOn API with retry logic"""
        vehicles = []
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Lincoln')),
...
def test_scraper():
    ...
    scraper = DaveSinclairLincolnStPetersOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Davesinclairlincolnstpeters")
    return vehicles
