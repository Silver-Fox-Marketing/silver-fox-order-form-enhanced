#!/usr/bin/env python3
"""
Southcountyautos Optimized Scraper
===================================
...
class SouthCountyAutosOptimizedScraper:
    """Production-optimized scraper for South County Autos"""
    
    def __init__(self):
        self.base_url = "https://www.southcountyautos.com"
...
def test_scraper():
    ...
    scraper = SouthCountyAutosOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Southcountyautos")
    return vehicles
