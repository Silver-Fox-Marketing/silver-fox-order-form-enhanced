#!/usr/bin/env python3
"""
Southcountyautos Original Scraper
=============================================
...
class SouthcountyautosOriginalScraper:
    """Original scraper for Southcountyautos"""
    
    def __init__(self):
        self.base_url = "https://southcountyautos.com"
        self.dealer_name = "Southcountyautos"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}southcountyautos_vehicles.json"
...
def test_scraper():
    ...
    scraper = SouthcountyautosOriginalScraper()
...
# 
# 		date_in_stock = ''
# 		street_addr = '7127 S Lindbergh Blvd'
# 		locality = 'St. Louis'
# 		postal_code = '63125'
# 		region = 'MO'
# 		country = 'US'
# 		location = 'South County Dodge Chrysler Jeep RAM'
# 
...
# 			status = 'In-Stock'
# 
# 		json_data = self.get_all_vehicles(f'https://www.southcountyautos.com/api/Inventory/getPaymentSettingDetails?accountId=27524&vin={vin}&styleid=', is_json=True)
# 
...
# 
# 			
# 	def start_scraping_southcountyautos(self):
# 
...
# 
# 		soup = self.get_all_vehicles('https://www.southcountyautos.com/sitemap.xml')
# 
