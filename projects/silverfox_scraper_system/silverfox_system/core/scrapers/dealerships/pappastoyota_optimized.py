#!/usr/bin/env python3
"""
Pappastoyota Optimized Scraper
===================================
...
class PappasToyotaOptimizedScraper:
    """Production-optimized scraper for Pappas Toyota"""
    
    def __init__(self):
        self.base_url = "https://www.pappastoyota.com"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Toyota')),
...
def test_scraper():
    ...
    scraper = PappasToyotaOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Pappastoyota")
    return vehicles
