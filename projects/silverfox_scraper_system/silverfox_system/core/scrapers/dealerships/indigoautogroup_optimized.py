#!/usr/bin/env python3
"""
Indigoautogroup Optimized Scraper
===================================
...
class IndigoAutoGroupOptimizedScraper:
    """Production-optimized scraper for Indigo Auto Group"""
    
    def __init__(self):
        self.base_url = "https://www.indigoautogroup.com"
...
def test_scraper():
    ...
    scraper = IndigoAutoGroupOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Indigoautogroup")
    return vehicles
