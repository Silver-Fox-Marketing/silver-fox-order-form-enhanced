...
class BommaritowestcountyWorkingScraper:
    """Scraper for Bommarito West County"""
    
    def __init__(self):
        self.base_url = "https://www.bommaritowestcounty.com"
        self.dealer_name = "Bommarito West County"
...
def test_scraper():
    ...
    scraper = BommaritowestcountyWorkingScraper()
