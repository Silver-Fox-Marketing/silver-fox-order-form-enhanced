#!/usr/bin/env python3
"""
Glendale Chrysler Jeep Scraper
==============================
...
class GlendalechryslerjeepWorkingScraper:
    """Scraper for Glendale Chrysler Jeep"""
    
    def __init__(self):
        self.base_url = "https://www.glendalechryslerjeep.com"
        self.dealer_name = "Glendale Chrysler Jeep"
...
def test_scraper():
    ...
    scraper = GlendalechryslerjeepWorkingScraper()
