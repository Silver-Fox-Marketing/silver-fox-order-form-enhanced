...
class ThoroughbredfordWorkingScraper:
    """Scraper for Thoroughbred Ford"""
    
    def __init__(self):
        self.base_url = "https://www.thoroughbredford.com"
        self.dealer_name = "Thoroughbred Ford"
...
def test_scraper():
    ...
    scraper = ThoroughbredfordWorkingScraper()
