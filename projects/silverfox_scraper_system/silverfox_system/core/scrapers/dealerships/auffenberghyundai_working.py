...
class AuffenberghyundaiWorkingScraper:
    """Scraper for Auffenberg Hyundai"""
    
    def __init__(self):
        self.base_url = "https://www.auffenberghyundai.com"
        self.dealer_name = "Auffenberg Hyundai"
...
def test_scraper():
    ...
    scraper = AuffenberghyundaiWorkingScraper()
