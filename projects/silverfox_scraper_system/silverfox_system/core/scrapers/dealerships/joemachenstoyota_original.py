#!/usr/bin/env python3
"""
Joemachenstoyota Original Scraper
=============================================
...
class JoemachenstoyotaOriginalScraper:
    """Original scraper for Joemachenstoyota"""
    
    def __init__(self):
        self.base_url = "https://joemachenstoyota.com"
        self.dealer_name = "Joemachenstoyota"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}joemachenstoyota_vehicles.json"
...
def test_scraper():
    ...
    scraper = JoemachenstoyotaOriginalScraper()
