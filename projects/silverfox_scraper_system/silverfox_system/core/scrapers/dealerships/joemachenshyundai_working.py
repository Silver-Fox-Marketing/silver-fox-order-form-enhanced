...
class JoemachenshyundaiWorkingScraper:
    """Scraper for Joe Machens Hyundai"""
        ...
        while True:
            try:
                ...
                payload = {
                    ...
                    "page": page,
                    "facetFilters": ["searchable_dealer_name:Joe Machens Hyundai"]
                }
...
def test_scraper():
    ...
    scraper = JoemachenshyundaiWorkingScraper()
