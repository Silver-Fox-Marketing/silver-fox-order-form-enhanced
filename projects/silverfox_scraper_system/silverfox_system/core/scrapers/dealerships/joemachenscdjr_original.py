#!/usr/bin/env python3
"""
Joemachenscdjr Original Scraper
=============================================
...
class JoemachenscdjrOriginalScraper:
    """Original scraper for Joemachenscdjr"""
    
    def __init__(self):
        self.base_url = "https://joemachenscdjr.com"
        self.dealer_name = "Joemachenscdjr"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}joemachenscdjr_vehicles.json"
...
def test_scraper():
    ...
    scraper = JoemachenscdjrOriginalScraper()
...
# 		status = json_data['special_field_5']
# 
# 		if status not in ['In Stock', 'InTransit']:
# 			status = ''
# 
# 		if status == 'InTransit':
# 			status = 'In-Transit'
...
# 		street_addr = '1310 Vandiver Dr'
# 		locality = 'Columbia'
# 		postal_code = '65202'
# 		region = 'MO'
# 		country = 'US'
# 		location = 'Joe Machens Chrysler Dodge Jeep Ram'
...
# 
# 		url = "https://10aprxotjr-dsn.algolia.net/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=003c8cddb5b15f2cfa774c02b7a3b59e&x-algolia-application-id=10APRXOTJR"
# 
# 		if mode == 'used':
# 			payload = json.dumps({
# 				"requests": [
# 			{
# 				"indexName": "joemachenschryslerdodgejeepram_production_inventory_low_to_high",
# 				"params": f"maxValuesPerFacet=250&hitsPerPage=20&page={page_num}&facets=%5B%22features%22%2C%22our_price%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.finance_monthly_payment%22%2C%22type%22%2C%22api_id%22%2C%22year%22%2C%22make%22%2C%22model%22%2C%22model_number%22%2C%22trim%22%2C%22body%22%2C%22doors%22%2C%22miles%22%2C%22ext_color_generic%22%2C%22features%22%2C%22lightning.isSpecial%22%2C%22lightning.locations%22%2C%22Location%22%2C%22in_transit_filter%22%2C%22lightning.status%22%2C%22lightning.class%22%2C%22fueltype%22%2C%22bedtype%22%2C%22engine_description%22%2C%22transmission_description%22%2C%22metal_flags%22%2C%22city_mpg%22%2C%22hw_mpg%22%2C%22days_in_stock%22%2C%22date_in_stock%22%2C%22ford_SpecialVehicle%22%2C%22lightning.isPolice%22%2C%22lightning.locations.meta_location%22%2C%22special_field_5%22%2C%22special_field_1%22%2C%22title_vrp%22%2C%22ext_color%22%2C%22int_color%22%2C%22certified%22%2C%22lightning%22%2C%22location%22%2C%22drivetrain%22%2C%22int_options%22%2C%22ext_options%22%2C%22cylinders%22%2C%22vin%22%2C%22stock%22%2C%22msrp%22%2C%22our_price_label%22%2C%22finance_details%22%2C%22lease_details%22%2C%22thumbnail%22%2C%22link%22%2C%22objectID%22%2C%22algolia_sort_order%22%2C%22date_modified%22%2C%22hash%22%5D&tagFilters=&facetFilters=%5B%5B%22type%3AUsed%22%2C%22type%3ACertified%20Used%22%5D%2C%5B%22Location%3AJoe%20Machens%20CDJR%22%5D%5D"
# 			},
# 			{
# 				"indexName": "joemachenschryslerdodgejeepram_production_inventory_low_to_high",
# 				"params": "maxValuesPerFacet=250&hitsPerPage=1&page=0&attributesToRetrieve=%5B%5D&attributesToHighlight=%5B%5D&attributesToSnippet=%5B%5D&tagFilters=&analytics=false&clickAnalytics=false&facets=type&facetFilters=%5B%5B%22Location%3AJoe%20Machens%20CDJR%22%5D%5D"
# 			},
# 			{
# 				"indexName": "joemachenschryslerdodgejeepram_production_inventory_low_to_high",
# 				"params": "maxValuesPerFacet=250&hitsPerPage=1&page=0&attributesToRetrieve=%5B%5D&attributesToHighlight=%5B%5D&attributesToSnippet=%5B%5D&tagFilters=&analytics=false&clickAnalytics=false&facets=Location&facetFilters=%5B%5B%22type%3AUsed%22%2C%22type%3ACertified%20Used%22%5D%5D"
# 			} ] })
# 
# 		else:
# 			payload = json.dumps({
# 				"requests": [
# 			{
# 				"indexName": "joemachenschryslerdodgejeepram_production_inventory_custom_make_date_sort",
# 				"params": f"maxValuesPerFacet=250&hitsPerPage=20&page={page_num}&facets=%5B%22features%22%2C%22our_price%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.finance_monthly_payment%22%2C%22type%22%2C%22api_id%22%2C%22year%22%2C%22make%22%2C%22model%22%2C%22model_number%22%2C%22trim%22%2C%22body%22%2C%22doors%22%2C%22miles%22%2C%22ext_color_generic%22%2C%22features%22%2C%22lightning.isSpecial%22%2C%22lightning.locations%22%2C%22Location%22%2C%22in_transit_filter%22%2C%22lightning.status%22%2C%22lightning.class%22%2C%22fueltype%22%2C%22bedtype%22%2C%22engine_description%22%2C%22transmission_description%22%2C%22metal_flags%22%2C%22city_mpg%22%2C%22hw_mpg%22%2C%22days_in_stock%22%2C%22date_in_stock%22%2C%22ford_SpecialVehicle%22%2C%22lightning.isPolice%22%2C%22lightning.locations.meta_location%22%2C%22special_field_5%22%2C%22special_field_1%22%2C%22title_vrp%22%2C%22ext_color%22%2C%22int_color%22%2C%22certified%22%2C%22lightning%22%2C%22location%22%2C%22drivetrain%22%2C%22int_options%22%2C%22ext_options%22%2C%22cylinders%22%2C%22vin%22%2C%22stock%22%2C%22msrp%22%2C%22our_price_label%22%2C%22finance_details%22%2C%22lease_details%22%2C%22thumbnail%22%2C%22link%22%2C%22objectID%22%2C%22algolia_sort_order%22%2C%22date_modified%22%2C%22hash%22%5D&tagFilters=&facetFilters=%5B%5B%22type%3ANew%22%5D%2C%5B%22Location%3AJoe%20Machens%20CDJR%22%5D%5D"
# 			},
# 			{
# 				"indexName": "joemachenschryslerdodgejeepram_production_inventory_custom_make_date_sort",
# 				"params": "maxValuesPerFacet=250&hitsPerPage=1&page=0&attributesToRetrieve=%5B%5D&attributesToHighlight=%5B%5D&attributesToSnippet=%5B%5D&tagFilters=&analytics=false&clickAnalytics=false&facets=type&facetFilters=%5B%5B%22Location%3AJoe%20Machens%20CDJR%22%5D%5D"
...
# 			{
# 				"indexName": "joemachenschryslerdodgejeepram_production_inventory_custom_make_date_sort",
# 				"params": "maxValuesPerFacet=250&hitsPerPage=1&page=0&attributesToRetrieve=%5B%5D&attributesToHighlight=%5B%5D&attributesToSnippet=%5B%5D&tagFilters=&analytics=false&clickAnalytics=false&facets=Location&facetFilters=%5B%5B%22type%3ANew%22%5D%5D"
# 			} ] })
# 
# 		headers = {
...
# 
# 			
# 	def start_scraping_joemachenscdjr(self):
# 
