#!/usr/bin/env python3
"""
Suntrupbuickgmc Optimized Scraper
===================================
...
class SuntrupBuickGmcOptimizedScraper:
    """Production-optimized scraper for Suntrup Buick GMC"""
    
    def __init__(self):
        self.base_url = "https://www.suntrupbuickgmc.com"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Buick')),
...
def test_scraper():
    ...
    scraper = SuntrupBuickGmcOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Suntrupbuickgmc")
    return vehicles
