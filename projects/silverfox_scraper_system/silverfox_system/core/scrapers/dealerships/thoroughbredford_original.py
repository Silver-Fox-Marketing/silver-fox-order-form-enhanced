#!/usr/bin/env python3
"""
Thoroughbredford Original Scraper
=============================================
...
class ThoroughbredfordOriginalScraper:
    """Original scraper for Thoroughbredford"""
    
    def __init__(self):
        self.base_url = "https://thoroughbredford.com"
        self.dealer_name = "Thoroughbredford"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}thoroughbredford_vehicles.json"
...
def test_scraper():
    ...
    scraper = ThoroughbredfordOriginalScraper()
