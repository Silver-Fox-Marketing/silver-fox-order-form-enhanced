#!/usr/bin/env python3
"""
West County Volvo Cars Scraper
==============================
...
class WcvolvocarsWorkingScraper:
    """Scraper for West County Volvo Cars"""
    
    def __init__(self):
        self.base_url = "https://www.wcvolvocars.com"
        self.dealer_name = "West County Volvo Cars"
...
def test_scraper():
    ...
    scraper = WcvolvocarsWorkingScraper()
