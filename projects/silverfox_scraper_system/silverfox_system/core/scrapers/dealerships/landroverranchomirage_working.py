...
class LandroverranchomirageWorkingScraper:
    """Scraper for Land Rover Ranch Mirage"""
    
    def __init__(self):
        self.base_url = "https://www.landroverranchomirage.com"
...
def test_scraper():
    ...
    scraper = LandroverranchomirageWorkingScraper()
