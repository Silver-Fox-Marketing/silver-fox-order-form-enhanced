#!/usr/bin/env python3
"""
Hondafrontenac Original Scraper
=============================================
...
class HondafrontenacOriginalScraper:
    """Original scraper for Hondafrontenac"""
    
    def __init__(self):
        self.base_url = "https://hondafrontenac.com"
        self.dealer_name = "Hondafrontenac"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}hondafrontenac_vehicles.json"
...
def test_scraper():
    ...
    scraper = HondafrontenacOriginalScraper()
