...
class HondafrontenacWorkingScraper:
    """Scraper for Honda of Frontenac"""
    
    def __init__(self):
        self.base_url = "https://www.hondafrontenac.com"
        self.dealer_name = "Honda of Frontenac"
...
def test_scraper():
    ...
    scraper = HondafrontenacWorkingScraper()
