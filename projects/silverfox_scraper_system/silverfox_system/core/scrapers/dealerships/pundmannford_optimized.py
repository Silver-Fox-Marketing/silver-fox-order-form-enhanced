#!/usr/bin/env python3
"""
Pundmannford Optimized Scraper
===================================
...
class PundmannFordOptimizedScraper:
    """Production-optimized scraper for Pundmann Ford"""
...
def test_scraper():
    ...
    scraper = PundmannFordOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Pundmannford")
    return vehicles
