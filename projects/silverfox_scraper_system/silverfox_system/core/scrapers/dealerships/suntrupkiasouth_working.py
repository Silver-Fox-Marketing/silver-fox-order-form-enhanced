...
class SuntrupkiasouthWorkingScraper:
    """Scraper for Suntrup Kia South"""
    
    def __init__(self):
        self.base_url = "https://www.suntrupkiasouth.com"
        self.dealer_name = "Suntrup Kia South"
...
def test_scraper():
    ...
    scraper = SuntrupkiasouthWorkingScraper()
