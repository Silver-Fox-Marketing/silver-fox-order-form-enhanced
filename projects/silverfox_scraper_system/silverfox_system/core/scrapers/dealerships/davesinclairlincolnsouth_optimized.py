#!/usr/bin/env python3
"""
Davesinclairlincolnsouth Optimized Scraper
===================================
...
class DaveSinclairLincolnSouthOptimizedScraper:
    """Production-optimized scraper for Dave Sinclair Lincoln South"""
    
    def __init__(self):
        self.base_url = "https://www.davesinclairlincolnsouth.com"
        self.dealer_name = "Davesinclairlincolnsouth"
...
def test_scraper():
    ...
    scraper = DaveSinclairLincolnSouthOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Davesinclairlincolnsouth")
    return vehicles
