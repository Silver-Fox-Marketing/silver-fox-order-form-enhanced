...
class HwKiaOptimizedScraper:
    """Production-optimized scraper for H&W Kia"""
    
    def __init__(self):
        self.base_url = "https://www.hwkia.com"
        self.dealer_name = "Hwkia"
...
def test_scraper():
    ...
    scraper = HwKiaOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Hwkia")
    return vehicles
