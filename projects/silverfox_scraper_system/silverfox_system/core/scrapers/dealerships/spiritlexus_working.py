...
class SpiritlexusWorkingScraper:
    """Scraper for Spirit Lexus"""
    
    def __init__(self):
        self.base_url = "https://www.spiritlexus.com"
        self.dealer_name = "Spirit Lexus"
        ...
        while True:
            try:
                ...
                payload = {
                    ...
                    "page": page,
                    "facetFilters": ["searchable_dealer_name:Spirit Lexus"]
                }
...
def test_scraper():
    ...
    scraper = SpiritlexusWorkingScraper()
