#!/usr/bin/env python3
"""
Pappastoyota Old Original Scraper
=============================================
...
class PappastoyotaOldOriginalScraper:
    """Original scraper for Pappastoyota Old"""
    
    def __init__(self):
        self.base_url = "https://pappastoyota_old.com"
        self.dealer_name = "Pappastoyota Old"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}pappastoyota_old_vehicles.json"
...
def test_scraper():
    ...
    scraper = PappastoyotaOldOriginalScraper()
