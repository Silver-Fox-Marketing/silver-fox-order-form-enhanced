...
class WeberChevroletOptimizedScraper:
    """Production-optimized scraper for Weber Chevrolet"""
    
    def __init__(self):
        self.base_url = "https://www.weberchev.com"
...
def test_scraper():
    ...
    scraper = WeberChevroletOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Weberchev")
    return vehicles
