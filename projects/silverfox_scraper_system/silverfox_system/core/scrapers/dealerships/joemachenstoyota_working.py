...
class JoemachenstoyotaWorkingScraper:
    """Scraper for Joe Machens Toyota"""
    
    def __init__(self):
        self.base_url = "https://www.joemachenstoyota.com"
        self.dealer_name = "Joe Machens Toyota"
...
def test_scraper():
    ...
    scraper = JoemachenstoyotaWorkingScraper()
