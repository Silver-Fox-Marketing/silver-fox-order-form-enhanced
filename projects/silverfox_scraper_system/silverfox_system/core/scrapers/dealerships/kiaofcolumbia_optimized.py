#!/usr/bin/env python3
"""
Kiaofcolumbia Optimized Scraper
===================================
...
class KiaOfColumbiaOptimizedScraper:
    """Production-optimized scraper for Kia of Columbia"""
    
    def __init__(self):
        self.base_url = "https://www.kiaofcolumbia.com"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Kia')),
...
def test_scraper():
    ...
    scraper = KiaOfColumbiaOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Kiaofcolumbia")
    return vehicles
