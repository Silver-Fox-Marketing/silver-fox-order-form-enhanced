...
class AudiranchomirageWorkingScraper:
    """Scraper for Audi Ranch Mirage"""
    
    def __init__(self):
        self.base_url = "https://www.audirancho.com"
        self.dealer_name = "Audi Ranch Mirage"
...
def test_scraper():
    ...
    scraper = AudiranchomirageWorkingScraper()
