#!/usr/bin/env python3
"""
Dave Sinclair Lincoln South Scraper
===================================
...
class DavesinclairlincolnsouthWorkingScraper:
    """Scraper for Dave Sinclair Lincoln South"""
...
def test_scraper():
    ...
    scraper = DavesinclairlincolnsouthWorkingScraper()
