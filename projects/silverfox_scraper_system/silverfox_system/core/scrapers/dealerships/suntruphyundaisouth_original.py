#!/usr/bin/env python3
"""
Suntruphyundaisouth Original Scraper
=============================================
...
class SuntruphyundaisouthOriginalScraper:
    """Original scraper for Suntruphyundaisouth"""
    
    def __init__(self):
        self.base_url = "https://suntruphyundaisouth.com"
        self.dealer_name = "Suntruphyundaisouth"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}suntruphyundaisouth_vehicles.json"
...
def test_scraper():
    ...
    scraper = SuntruphyundaisouthOriginalScraper()
...
# 		street_addr = '5926 S Lindbergh Blvd'
# 		locality = 'St. Louis'
# 		postal_code = '63123'
# 		region = 'MO'
# 		country = 'US'
# 		location = 'Suntrup Hyundai South'
...
# 
# 		url = "https://1wnybzleen-dsn.algolia.net/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.22.4)&x-algolia-api-key=e2acb682178e9dcc22d18ecb2ff7d9e4&x-algolia-application-id=1WNYBZLEEN"
# 
# 
# 		if mode == 'used':
# 			payload = json.dumps({
# 			"requests": [
# 			{
# 			"indexName": "suntruphyundaisouth-sbm20824_production_inventory_specials_oem_price",
# 			"params": f"facetFilters=%5B%5B%22lightning.locations.Location%3ASuntrup%20Hyundai%20South%22%5D%2C%5B%22make%3AHYUNDAI%22%5D%2C%5B%22type%3ACertified%20Used%22%2C%22type%3AUsed%22%5D%5D&facets=%5B%22Location%22%2C%22Location_used%22%2C%22algolia_sort_order%22%2C%22api_id%22%2C%22bedtype%22%2C%22body%22%2C%22cap_one%22%2C%22certified%22%2C%22city_mpg%22%2C%22custom_loaner_feed_value%22%2C%22cylinders%22%2C%22date_in_stock%22%2C%22date_modified%22%2C%22days_in_stock%22%2C%22doors%22%2C%22drivetrain%22%2C%22engine_description%22%2C%22ext_color%22%2C%22ext_color_generic%22%2C%22ext_options%22%2C%22features%22%2C%22features%22%2C%22finance_details%22%2C%22ford_SpecialVehicle%22%2C%22fueltype%22%2C%22hash%22%2C%22hw_mpg%22%2C%22in_transit_filter%22%2C%22int_color%22%2C%22int_options%22%2C%22lease_details%22%2C%22lightning%22%2C%22lightning.class%22%2C%22lightning.finance_monthly_payment%22%2C%22lightning.isPolice%22%2C%22lightning.isSpecial%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.locations%22%2C%22lightning.locations.Location%22%2C%22lightning.locations.meta_location%22%2C%22lightning.status%22%2C%22link%22%2C%22location%22%2C%22make%22%2C%22metal_flags%22%2C%22miles%22%2C%22model%22%2C%22model_number%22%2C%22monroneyLabel%22%2C%22msrp%22%2C%22objectID%22%2C%22our_price%22%2C%22our_price_label%22%2C%22special_field_1%22%2C%22stock%22%2C%22thumbnail%22%2C%22title_vrp%22%2C%22transmission_description%22%2C%22trim%22%2C%22type%22%2C%22used_test%22%2C%22vin%22%2C%22year%22%5D&hitsPerPage=20&maxValuesPerFacet=250&page={page_num}"
# 			},
# 			{
# 			"indexName": "suntruphyundaisouth-sbm20824_production_inventory_specials_oem_price",
# 			"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22make%3AHYUNDAI%22%5D%2C%5B%22type%3ACertified%20Used%22%2C%22type%3AUsed%22%5D%5D&facets=lightning.locations.Location&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 			},
# 			{
# 			"indexName": "suntruphyundaisouth-sbm20824_production_inventory_specials_oem_price",
# 			"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22lightning.locations.Location%3ASuntrup%20Hyundai%20South%22%5D%2C%5B%22type%3ACertified%20Used%22%2C%22type%3AUsed%22%5D%5D&facets=make&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 			},
# 			{
# 			"indexName": "suntruphyundaisouth-sbm20824_production_inventory_specials_oem_price",
# 			"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22lightning.locations.Location%3ASuntrup%20Hyundai%20South%22%5D%2C%5B%22make%3AHYUNDAI%22%5D%5D&facets=type&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 			}
# 			]
# 			})
# 
...
# 			{
# 			"indexName": "suntruphyundaisouth-sbm20824_production_inventory_specials_oem_price",
# 			"params": f"facetFilters=%5B%5B%22lightning.locations.Location%3ASuntrup%20Hyundai%20South%22%5D%2C%5B%22make%3AHYUNDAI%22%5D%2C%5B%22type%3ANew%22%5D%5D&facets=%5B%22Location%22%2C%22Location_used%22%2C%22algolia_sort_order%22%2C%22api_id%22%2C%22bedtype%22%2C%22body%22%2C%22cap_one%22%2C%22certified%22%2C%22city_mpg%22%2C%22custom_loaner_feed_value%22%2C%22cylinders%22%2C%22date_in_stock%22%2C%22date_modified%22%2C%22days_in_stock%22%2C%22doors%22%2C%22drivetrain%22%2C%22engine_description%22%2C%22ext_color%22%2C%22ext_color_generic%22%2C%22ext_options%22%2C%22features%22%2C%22features%22%2C%22finance_details%22%2C%22ford_SpecialVehicle%22%2C%22fueltype%22%2C%22hash%22%2C%22hw_mpg%22%2C%22in_transit_filter%22%2C%22int_color%22%2C%22int_options%22%2C%22lease_details%22%2C%22lightning%22%2C%22lightning.class%22%2C%22lightning.finance_monthly_payment%22%2C%22lightning.isPolice%22%2C%22lightning.isSpecial%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.locations%22%2C%22lightning.locations.Location%22%2C%22lightning.locations.meta_location%22%2C%22lightning.status%22%2C%22link%22%2C%22location%22%2C%22make%22%2C%22metal_flags%22%2C%22miles%22%2C%22model%22%2C%22model_number%22%2C%22monroneyLabel%22%2C%22msrp%22%2C%22objectID%22%2C%22our_price%22%2C%22our_price_label%22%2C%22special_field_1%22%2C%22stock%22%2C%22thumbnail%22%2C%22title_vrp%22%2C%22transmission_description%22%2C%22trim%22%2C%22type%22%2C%22used_test%22%2C%22vin%22%2C%22year%22%5D&hitsPerPage=20&maxValuesPerFacet=250&page={page_num}"
# 			},
# 			{
# 			"indexName": "suntruphyundaisouth-sbm20824_production_inventory_specials_oem_price",
# 			"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22make%3AHYUNDAI%22%5D%2C%5B%22type%3ANew%22%5D%5D&facets=lightning.locations.Location&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 			},
# 			{
# 			"indexName": "suntruphyundaisouth-sbm20824_production_inventory_specials_oem_price",
# 			"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22lightning.locations.Location%3ASuntrup%20Hyundai%20South%22%5D%2C%5B%22type%3ANew%22%5D%5D&facets=make&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 			},
# 			{
# 			"indexName": "suntruphyundaisouth-sbm20824_production_inventory_specials_oem_price",
# 			"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22lightning.locations.Location%3ASuntrup%20Hyundai%20South%22%5D%2C%5B%22make%3AHYUNDAI%22%5D%5D&facets=type&hitsPerPage=0&maxValuesPerFacet=250&page=0"
...
# 
# 			
# 	def start_scraping_suntruphyundaisouth(self):
# 
