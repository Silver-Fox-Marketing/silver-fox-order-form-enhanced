#!/usr/bin/env python3
"""
Miniofstlouis Optimized Scraper
===================================
...
class MiniOfStLouisOptimizedScraper:
    """Production-optimized scraper for MINI of St. Louis"""
    
    def __init__(self):
        self.base_url = "https://www.miniofstlouis.com"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'MINI')),
...
def test_scraper():
    ...
    scraper = MiniOfStLouisOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Miniofstlouis")
    return vehicles
