...
class WeberchevWorkingScraper:
    """Scraper for Weber Chevrolet"""
    
    def __init__(self):
        self.base_url = "https://www.weberchev.com"
        self.dealer_name = "Weber Chevrolet"
        ...
        while True:
            try:
                ...
                payload = {
                    ...
                    "page": page,
                    "facetFilters": ["searchable_dealer_name:Weber Chevrolet"]
                }
...
def test_scraper():
    ...
    scraper = WeberchevWorkingScraper()
