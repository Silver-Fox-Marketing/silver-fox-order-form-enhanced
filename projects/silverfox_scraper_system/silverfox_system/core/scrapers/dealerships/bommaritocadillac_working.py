...
class BommaritocadillacWorkingScraper:
    """Scraper for Bommarito Cadillac"""
    
    def __init__(self):
        self.base_url = "https://www.bommaritocadillac.com"
        self.dealer_name = "Bommarito Cadillac"
...
def test_scraper():
    ...
    scraper = BommaritocadillacWorkingScraper()
