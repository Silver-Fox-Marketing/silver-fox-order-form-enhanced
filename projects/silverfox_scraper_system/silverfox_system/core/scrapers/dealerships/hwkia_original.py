...
class HwkiaOriginalScraper:
    """Original scraper for Hwkia"""
    
    def __init__(self):
        self.base_url = "https://hwkia.com"
        self.dealer_name = "Hwkia"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}hwkia_vehicles.json"
