...
class JoemachensnissanWorkingScraper:
    """Scraper for Joe Machens Nissan"""
    
    def __init__(self):
        self.base_url = "https://www.joemachensnissan.com"
        self.dealer_name = "Joe Machens Nissan"
...
def test_scraper():
    ...
    scraper = JoemachensnissanWorkingScraper()
