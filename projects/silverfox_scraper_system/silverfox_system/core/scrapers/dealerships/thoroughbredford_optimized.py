#!/usr/bin/env python3
"""
Thoroughbredford Optimized Scraper
===================================
...
class ThoroughbredFordOptimizedScraper:
    """Production-optimized scraper for Thoroughbred Ford"""
    
    def __init__(self):
        self.base_url = "https://www.thoroughbredford.com"
        self.dealer_name = "Thoroughbredford"
...
def test_scraper():
    ...
    scraper = ThoroughbredFordOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Thoroughbredford")
    return vehicles
