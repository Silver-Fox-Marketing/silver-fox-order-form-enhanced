#!/usr/bin/env python3
"""
Miniofstlouis Original Scraper
=============================================
...
class MiniofstlouisOriginalScraper:
    """Original scraper for Miniofstlouis"""
    
    def __init__(self):
        self.base_url = "https://miniofstlouis.com"
        self.dealer_name = "Miniofstlouis"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}miniofstlouis_vehicles.json"
...
def test_scraper():
    ...
    scraper = MiniofstlouisOriginalScraper()
...
# 			time.sleep(1)
# 
# 	def start_scraping_miniofstlouis(self):
# 
...
# 
# 				if mode == 'used':
# 					url = f'https://www.miniofstlouis.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start={page_num}'
# 				else:
# 					url = f'https://www.miniofstlouis.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start={page_num}'
# 
...
# 
# 					vehicle_url = f'https://www.miniofstlouis.com' + vehicle['link']
# 
