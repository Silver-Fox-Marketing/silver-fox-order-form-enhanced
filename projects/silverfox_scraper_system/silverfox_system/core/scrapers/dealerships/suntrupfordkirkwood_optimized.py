#!/usr/bin/env python3
"""
Suntrupfordkirkwood Optimized Scraper
===================================
...
class SuntrupFordKirkwoodOptimizedScraper:
    """Production-optimized scraper for Suntrup Ford Kirkwood"""
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Ford')),
...
def test_scraper():
    ...
    scraper = SuntrupFordKirkwoodOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Suntrupfordkirkwood")
    return vehicles
