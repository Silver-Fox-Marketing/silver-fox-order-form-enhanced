#!/usr/bin/env python3
"""
Bmwofweststlouis Original Scraper
=============================================
...
class BmwofweststlouisOriginalScraper:
    """Original scraper for Bmwofweststlouis"""
    
    def __init__(self):
        self.base_url = "https://bmwofweststlouis.com"
        self.dealer_name = "Bmwofweststlouis"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}bmwofweststlouis_vehicles.json"
...
def test_scraper():
    ...
    scraper = BmwofweststlouisOriginalScraper()
...
# 				}, {
# 					"indexName": "bmwofweststlouis_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22type%3ACertified%20Pre-Owned%22%2C%22type%3APre-Owned%22%5D%5D&facets=Location&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				}, {
# 					"indexName": "bmwofweststlouis_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22Location%3ABMW%20of%20West%20St.%20Louis%3Cbr%3E%3Ca%20href%3D%5C%22https%3A%2F%2Fmaps.app.goo.gl%2FQyXQWdf6BV6jobY18%5C%22%20target%3D%5C%22_blank%5C%22%3E14417%20Manchester%20Road%3Cbr%3EManchester%2C%20MO%2063011%3C%2Fa%3E%3Cbr%3E%3Ca%20href%3D%5C%22tel%3A888-291-4102%5C%22%3E888-291-4102%3C%2Fa%3E%22%5D%5D&facets=type&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				} ] })
# 
# 		elif mode == 'certified':
# 
...
# 				}, {
# 					"indexName": "bmwofweststlouis_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22make%3ABMW%22%5D%2C%5B%22type%3ACertified%20Pre-Owned%22%5D%5D&facets=Location&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				}, {
# 					"indexName": "bmwofweststlouis_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22Location%3ABMW%20of%20West%20St.%20Louis%3Cbr%3E%3Ca%20href%3D%5C%22https%3A%2F%2Fmaps.app.goo.gl%2FQyXQWdf6BV6jobY18%5C%22%20target%3D%5C%22_blank%5C%22%3E14417%20Manchester%20Road%3Cbr%3EManchester%2C%20MO%2063011%3C%2Fa%3E%3Cbr%3E%3Ca%20href%3D%5C%22tel%3A888-291-4102%5C%22%3E888-291-4102%3C%2Fa%3E%22%5D%2C%5B%22type%3ACertified%20Pre-Owned%22%5D%5D&facets=make&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				}, {
# 					"indexName": "bmwofweststlouis_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22Location%3ABMW%20of%20West%20St.%20Louis%3Cbr%3E%3Ca%20href%3D%5C%22https%3A%2F%2Fmaps.app.goo.gl%2FQyXQWdf6BV6jobY18%5C%22%20target%3D%5C%22_blank%5C%22%3E14417%20Manchester%20Road%3Cbr%3EManchester%2C%20MO%2063011%3C%2Fa%3E%3Cbr%3E%3Ca%20href%3D%5C%22tel%3A888-291-4102%5C%22%3E888-291-4102%3C%2Fa%3E%22%5D%2C%5B%22make%3ABMW%22%5D%5D&facets=type&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				} ] })
# 
# 		else:
# 
...
# 				}, {
# 					"indexName": "bmwofweststlouis_production_inventory_sort_image_type_price_lh",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22type%3ANew%22%5D%5D&facets=Location&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				}, {
# 						"indexName": "bmwofweststlouis_production_inventory_sort_image_type_price_lh",
# 				"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22Location%3ABMW%20of%20West%20St.%20Louis%3Cbr%3E%3Ca%20href%3D%5C%22https%3A%2F%2Fmaps.app.goo.gl%2FQyXQWdf6BV6jobY18%5C%22%20target%3D%5C%22_blank%5C%22%3E14417%20Manchester%20Road%3Cbr%3EManchester%2C%20MO%2063011%3C%2Fa%3E%3Cbr%3E%3Ca%20href%3D%5C%22tel%3A888-291-4102%5C%22%3E888-291-4102%3C%2Fa%3E%22%5D%5D&facets=type&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				} ] })
...
# 
# 			
# 	def start_scraping_bmwofweststlouis(self):
# 
