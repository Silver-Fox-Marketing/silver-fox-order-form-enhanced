#!/usr/bin/env python3
"""
Porschestlouis Optimized Scraper
===================================
...
class PorscheStLouisOptimizedScraper:
    """Production-optimized scraper for Porsche St. Louis"""
    
    def __init__(self):
        self.base_url = "https://www.porschestlouis.com"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Porsche')),
...
def test_scraper():
    ...
    scraper = PorscheStLouisOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Porschestlouis")
    return vehicles
