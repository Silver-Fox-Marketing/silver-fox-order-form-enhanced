#!/usr/bin/env python3
"""
Suntrupfordwest Original Scraper
=============================================
...
class SuntrupfordwestOriginalScraper:
    """Original scraper for Suntrupfordwest"""
    
    def __init__(self):
        self.base_url = "https://suntrupfordwest.com"
        self.dealer_name = "Suntrupfordwest"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}suntrupfordwest_vehicles.json"
...
def test_scraper():
    ...
    scraper = SuntrupfordwestOriginalScraper()
...
# 		street_addr = '2020 Kratky Rd'
# 		locality = 'Saint Louis'
# 		postal_code = '63114'
# 		region = 'MO'
# 		country = 'US'
# 		location = 'Suntrup Ford Westport'
...
# 
# 			
# 	def start_scraping_suntrupfordwest(self):
# 
...
# 
# 		soup = self.helper.make_soup_url('https://www.suntrupfordwest.com/searchall.aspx?Dealership=Suntrup%20Ford%20Westport')
...
# 		while 1:
# 
# 			url = f'https://www.suntrupfordwest.com/api/vhcliaa/vehicle-pages/cosmos/srp/vehicles/{dealer_id}/{page_id}?pt={page_num}'
# 			url += f'&Dealership=Suntrup%20Ford%20Westport&host=www.suntrupfordwest.com&pn=12&displayCardsShown={display_cards}'
# 
