#!/usr/bin/env python3
"""
Jaguar Ranch Mirage Optimized Scraper
===================================
...
class JaguarRanchMirageOptimizedScraper:
    """Production-optimized scraper for Jaguar Ranch Mirage"""
    
    def __init__(self):
        self.base_url = "https://www.jaguarranchmirage.com"
        self.dealer_name = "Jaguar Ranch Mirage"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Jaguar')),
...
def test_scraper():
    ...
    scraper = JaguarRanchMirageOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Jaguar Ranch Mirage")
    return vehicles
