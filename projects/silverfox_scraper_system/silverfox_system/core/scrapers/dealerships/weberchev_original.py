...
class WeberchevOriginalScraper:
    """Original scraper for Weberchev"""
    
    def __init__(self):
        self.base_url = "https://weberchev.com"
        self.dealer_name = "Weberchev"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}weberchev_vehicles.json"
...
def test_scraper():
    ...
    scraper = WeberchevOriginalScraper()
...
# 
# 		status = json_data.get('custom_status', '')
# 
# 		if not status:
...
# 		street_addr = '12015 Olive Blvd 12015 Olive Blvd'
# 		locality = "Creve Coeur"
# 		postal_code = '63141'
# 		region = 'MO'
# 		country = 'US'
# 		location = "Weber Creve Coeur"
...
# 
# 		url = "https://equ6hxb6wg-dsn.algolia.net/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.24.0)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.23.1)&x-algolia-api-key=da97ef494552f47ecc6f47068888d120&x-algolia-application-id=EQU6HXB6WG"
# 
# 		payload = json.dumps({
# 				"requests": [
# 			{
# 				"indexName": "weberchevroletcrevecoeur_production_inventory_low_to_high",
# 				"params": f"facetFilters=%5B%5B%22type%3ACarBravo%22%2C%22type%3ADemo%22%2C%22type%3ANew%22%2C%22type%3AUsed%22%5D%5D&facets=%5B%22Location%22%2C%22algolia_sort_order%22%2C%22api_id%22%2C%22bedtype%22%2C%22body%22%2C%22capacity%22%2C%22certified%22%2C%22city_mpg%22%2C%22custom_cab%22%2C%22custom_status%22%2C%22cylinders%22%2C%22date_in_stock%22%2C%22date_modified%22%2C%22days_in_stock%22%2C%22doors%22%2C%22drivetrain%22%2C%22engine_description%22%2C%22ext_color%22%2C%22ext_color_generic%22%2C%22ext_options%22%2C%22features%22%2C%22features%22%2C%22finance_details%22%2C%22ford_SpecialVehicle%22%2C%22fueltype%22%2C%22hash%22%2C%22hw_mpg%22%2C%22in_transit_filter%22%2C%22int_color%22%2C%22int_options%22%2C%22lease_details%22%2C%22lightning%22%2C%22lightning.class%22%2C%22lightning.finance_monthly_payment%22%2C%22lightning.isPolice%22%2C%22lightning.isSpecial%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.locations%22%2C%22lightning.locations.meta_location%22%2C%22lightning.status%22%2C%22link%22%2C%22location%22%2C%22make%22%2C%22make_sort%22%2C%22metal_flags%22%2C%22miles%22%2C%22model%22%2C%22model_number%22%2C%22msrp%22%2C%22objectID%22%2C%22our_price%22%2C%22our_price_label%22%2C%22special_field_1%22%2C%22special_field_11%22%2C%22special_field_5%22%2C%22stock%22%2C%22thumbnail%22%2C%22title_vrp%22%2C%22transmission_description%22%2C%22trim%22%2C%22type%22%2C%22used_highlight_vrp%22%2C%22vin%22%2C%22year%22%5D&hitsPerPage=20&maxValuesPerFacet=250&page={page_num}"
# 			}, {
# 				"indexName": "weberchevroletcrevecoeur_production_inventory_low_to_high",
...
# 
# 			
# 	def start_scraping_weberchev(self):
# 
