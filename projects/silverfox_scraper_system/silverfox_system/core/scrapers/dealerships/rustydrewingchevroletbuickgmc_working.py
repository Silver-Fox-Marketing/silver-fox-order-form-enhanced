...
class RustydrewingchevroletbuickgmcWorkingScraper:
    """Scraper for Rusty Drewing Chevrolet Buick GMC"""
    
    def __init__(self):
        self.base_url = "https://www.rustydrewingchevroletbuickgmc.com"
        self.dealer_name = "Rusty Drewing Chevrolet Buick GMC"
...
def test_scraper():
    ...
    scraper = RustydrewingchevroletbuickgmcWorkingScraper()
