#!/usr/bin/env python3
"""
BMW of West St. Louis Optimized Scraper
===================================
...
class BmwOfWestStLouisOptimizedScraper:
    """Production-optimized scraper for BMW of West St. Louis"""
    
    def __init__(self):
        self.base_url = "https://www.bmwofwestst.louis.com"
...
def test_scraper():
    ...
    scraper = BmwOfWestStLouisOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for BMW of West St. Louis")
    return vehicles
