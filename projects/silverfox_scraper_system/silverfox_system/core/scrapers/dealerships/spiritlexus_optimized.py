...
class SpiritLexusOptimizedScraper:
    """Production-optimized scraper for Spirit Lexus"""
    
    def __init__(self):
        self.base_url = "https://www.spiritlexus.com"
        self.dealer_name = "Spiritlexus"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Lexus')),
...
def test_scraper():
    ...
    scraper = SpiritLexusOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Spiritlexus")
    return vehicles
