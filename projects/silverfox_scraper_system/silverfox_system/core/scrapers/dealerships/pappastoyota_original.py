...
class PappastoyotaOriginalScraper:
    """Original scraper for Pappastoyota"""
    
    def __init__(self):
        self.base_url = "https://pappastoyota.com"
        self.dealer_name = "Pappastoyota"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}pappastoyota_vehicles.json"
...
def test_scraper():
    ...
    scraper = PappastoyotaOriginalScraper()
...
# 
# 		url = "https://sewjn80htn-dsn.algolia.net/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.24.0)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.23.1)&x-algolia-api-key=179608f32563367799314290254e3e44&x-algolia-application-id=SEWJN80HTN"
# 
# 
# 		if mode == 'used':
# 			
