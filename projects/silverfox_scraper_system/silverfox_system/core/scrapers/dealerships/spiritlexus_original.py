...
class SpiritlexusOriginalScraper:
    """Original scraper for Spiritlexus"""
    
    def __init__(self):
        self.base_url = "https://spiritlexus.com"
        self.dealer_name = "Spiritlexus"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}spiritlexus_vehicles.json"
...
def test_scraper():
    ...
    scraper = SpiritlexusOriginalScraper()
