...
class SuntrupfordkirkwoodWorkingScraper:
    """Scraper for Suntrup Ford Kirkwood"""
    
    def __init__(self):
        self.base_url = "https://www.suntrupfordkirkwood.com"
        self.dealer_name = "Suntrup Ford Kirkwood"
...
def test_scraper():
    ...
    scraper = SuntrupfordkirkwoodWorkingScraper()
