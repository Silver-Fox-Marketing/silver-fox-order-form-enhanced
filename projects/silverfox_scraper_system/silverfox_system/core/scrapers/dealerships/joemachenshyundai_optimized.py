#!/usr/bin/env python3
"""
Joe Machens Hyundai Optimized Scraper
===================================
...
class JoeMachensHyundaiOptimizedScraper:
    """Production-optimized scraper for Joe Machens Hyundai"""
    
    def __init__(self):
        self.base_url = "https://www.joemachenshyundai.com"
        self.dealer_name = "Joe Machens Hyundai"
...
def test_scraper():
    ...
    scraper = JoeMachensHyundaiOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Joe Machens Hyundai")
    return vehicles
