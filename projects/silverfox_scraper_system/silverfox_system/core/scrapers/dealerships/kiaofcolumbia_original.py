#!/usr/bin/env python3
"""
Kiaofcolumbia Original Scraper
=============================================
...
class KiaofcolumbiaOriginalScraper:
    """Original scraper for Kiaofcolumbia"""
    
    def __init__(self):
        self.base_url = "https://kiaofcolumbia.com"
        self.dealer_name = "Kiaofcolumbia"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}kiaofcolumbia_vehicles.json"
...
def test_scraper():
    ...
    scraper = KiaofcolumbiaOriginalScraper()
...
# 
# 		try:
# 			v_location = soup.find('span', string=re.compile('Location:')).text.strip().lower()
# 		except:
# 			try:
# 				v_location = soup.find('span', class_='location-label-custom').text.strip().lower()
# 			except:
# 				v_location = ''
# 
# 		v_location = ' '.join(v_location.split())
# 
# 		if v_location and 'kia of columbia' not in v_location:
# 			return True
# 
...
# 		except:
# 			try:
# 				stock = soup.find('p', string='Stock').parent.text.strip().split('Stock')[1].strip()
# 			except:
# 				stock = ''
# 
...
# 
# 		date_in_stock = ''
# 		street_addr = '710 Business Loop 70 W'
# 		locality = 'Columbia'
# 		postal_code = '65203'
# 		region = 'MO'
# 		country = 'US'
# 		location = 'Kia of Columbia'
# 
# 		if 0:
...
# 
# 		json_data = self.get_all_vehicles(f'https://www.kiaofcolumbia.com/api/Inventory/getPaymentSettingDetails?accountId=41336&vin={vin}&styleid=', is_json=True)
# 
...
# 
# 			
# 	def start_scraping_kiaofcolumbia(self):
# 
...
# 
# 		soup = self.get_all_vehicles('https://www.kiaofcolumbia.com/sitemap.xml')
# 
