...
class IndigoautogroupWorkingScraper:
    """Scraper for Indigo Auto Group"""
    
    def __init__(self):
        self.base_url = "https://www.indigoautogroup.com"
        self.dealer_name = "Indigo Auto Group"
...
def test_scraper():
    ...
    scraper = IndigoautogroupWorkingScraper()
