#!/usr/bin/env python3
"""
Serrahondaofallon Optimized Scraper
===================================
...
class SerraHondaOfOfallonOptimizedScraper:
    """Production-optimized scraper for Serra Honda of O'Fallon"""
    
    def __init__(self):
        self.base_url = "https://www.serrahondaofallon.com"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Honda')),
...
def test_scraper():
    ...
    scraper = SerraHondaOfOfallonOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Serrahondaofallon")
    return vehicles
