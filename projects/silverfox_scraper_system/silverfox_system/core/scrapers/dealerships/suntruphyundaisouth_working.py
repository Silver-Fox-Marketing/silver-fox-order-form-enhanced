...
class SuntruphyundaisouthWorkingScraper:
    """Scraper for Suntrup Hyundai South"""
    
    def __init__(self):
        self.base_url = "https://www.suntruphyundaisouth.com"
        self.dealer_name = "Suntrup Hyundai South"
...
def test_scraper():
    ...
    scraper = SuntruphyundaisouthWorkingScraper()
