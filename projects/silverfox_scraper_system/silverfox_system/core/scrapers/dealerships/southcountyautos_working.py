...
class SouthcountyautosWorkingScraper:
    """Scraper for South County Autos"""
    
    def __init__(self):
        self.base_url = "https://www.southcountyautos.com"
        self.dealer_name = "South County Autos"
...
def test_scraper():
    ...
    scraper = SouthcountyautosWorkingScraper()
