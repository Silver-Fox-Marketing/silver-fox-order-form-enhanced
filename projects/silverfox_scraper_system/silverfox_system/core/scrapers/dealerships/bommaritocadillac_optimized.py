#!/usr/bin/env python3
"""
Bommaritocadillac Optimized Scraper
===================================
...
class BommaritoCadillacOptimizedScraper:
    """Production-optimized scraper for Bommarito Cadillac"""
    
    def __init__(self):
        self.base_url = "https://www.bommaritocadillac.com"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Cadillac')),
...
def test_scraper():
    ...
    scraper = BommaritoCadillacOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Bommaritocadillac")
    return vehicles
