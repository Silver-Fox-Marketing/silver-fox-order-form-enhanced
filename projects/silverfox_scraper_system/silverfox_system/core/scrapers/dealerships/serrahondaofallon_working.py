#!/usr/bin/env python3
"""
Serra Honda of O'Fallon Scraper
===============================
...
class SerrahondaofallonWorkingScraper:
    """Scraper for Serra Honda of O'Fallon"""
    
    def __init__(self):
        self.base_url = "https://www.serrahondaofallon.com"
        self.dealer_name = "Serra Honda of O'Fallon"
...
def test_scraper():
    ...
    scraper = SerrahondaofallonWorkingScraper()
