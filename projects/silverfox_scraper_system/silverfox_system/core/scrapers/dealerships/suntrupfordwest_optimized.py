#!/usr/bin/env python3
"""
Suntrup Ford West Optimized Scraper
===================================
...
class SuntrupFordWestOptimizedScraper:
    """Production-optimized scraper for Suntrup Ford West"""
...
def test_scraper():
    ...
    scraper = SuntrupFordWestOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Suntrup Ford West")
    return vehicles
