#!/usr/bin/env python3
"""
Bommaritowestcounty Optimized Scraper
===================================
...
class BommaritoWestCountyOptimizedScraper:
    """Production-optimized scraper for Bommarito West County"""
    
    def __init__(self):
        self.base_url = "https://www.bommaritowestcounty.com"
        self.dealer_name = "Bommaritowestcounty"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Multiple')),
...
def test_scraper():
    ...
    scraper = BommaritoWestCountyOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Bommaritowestcounty")
    return vehicles
