...
class WestCountyVolvoCarsOptimizedScraper:
    """Production-optimized scraper for West County Volvo Cars"""
    
    def __init__(self):
        self.base_url = "https://www.wcvolvocars.com"
...
def test_scraper():
    ...
    scraper = WestCountyVolvoCarsOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Wcvolvocars")
    return vehicles
