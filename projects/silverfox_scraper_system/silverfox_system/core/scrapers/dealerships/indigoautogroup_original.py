#!/usr/bin/env python3
"""
Indigoautogroup Original Scraper
=============================================
...
class IndigoautogroupOriginalScraper:
    """Original scraper for Indigoautogroup"""
    
    def __init__(self):
        self.base_url = "https://indigoautogroup.com"
        self.dealer_name = "Indigoautogroup"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}indigoautogroup_vehicles.json"
...
def test_scraper():
    ...
    scraper = IndigoautogroupOriginalScraper()
...
# 			status = 'In-stock'
# 
# 		if json_data['VehicleInTransit']:
# 			status = 'In-transit'
# 
# 		if not json_data['ShowStatus']:
# 			status = ''
# 
# 		try:
...
# 		street_addr = '71387 Highway 111'
# 		locality = 'Rancho Mirage'
# 		postal_code = '92270'
# 		region = 'CA'
# 		country = 'US'
# 		location = 'indiGO Auto Group'
...
# 
# 			
# 	def start_scraping_indigoautogroup(self):
# 
...
# 
# 		soup = self.helper.make_soup_url('https://www.indigoautogroup.com/searchall.aspx?Location=Rancho%20Mirage%2C%20CA&pt=1')
...
# 		while 1:
# 
# 			url = f'https://www.indigoautogroup.com/api/vhcliaa/vehicle-pages/cosmos/srp/vehicles/{dealer_id}/{page_id}'
# 			url += f'?Location=Rancho%20Mirage%2C%20CA&host=www.indigoautogroup.com&pt={page_num}&pn=24&baseFilter=KHR5cGUgPSAnbicpIG9yICh0eXBlID0gJ3UnKQ==&displayCardsShown={display_cards}'
# 
...
# 				print()
# 
# 			if page_num >= total_pages or len(all_vehicles) < 24:
# 				break
# 
# 			page_num += 1
# 
