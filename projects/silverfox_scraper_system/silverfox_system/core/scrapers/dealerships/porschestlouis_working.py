...
class PorschestlouisWorkingScraper:
    """Scraper for Porsche St. Louis"""
    
    def __init__(self):
        self.base_url = "https://www.porschestlouis.com"
        self.dealer_name = "Porsche St. Louis"
...
def test_scraper():
    ...
    scraper = PorschestlouisWorkingScraper()
