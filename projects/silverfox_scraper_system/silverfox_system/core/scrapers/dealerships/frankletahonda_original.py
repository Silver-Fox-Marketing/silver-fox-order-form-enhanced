#!/usr/bin/env python3
"""
Frankletahonda Original Scraper
=============================================
...
class FrankletahondaOriginalScraper:
    """Original scraper for Frankletahonda"""
    
    def __init__(self):
        self.base_url = "https://frankletahonda.com"
        self.dealer_name = "Frankletahonda"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}frankletahonda_vehicles.json"
...
def test_scraper():
    ...
    scraper = FrankletahondaOriginalScraper()
...
# 		status = json_data.get('vehicle_status_filter', '')
...
# 		street_addr = '500 Auto Mall Drive'
# 		locality = "O'Fallon"
# 		postal_code = '63368'
# 		region = 'MO'
# 		country = 'US'
...
# 				"requests": [
# 				{
# 					"indexName": "frankletahonda-winback0122_production_inventory_specials_oem_price",
# 					"params": f"facetFilters=%5B%5B%22Location%3AO'Fallon%22%5D%2C%5B%22type%3ACertified%20Used%22%2C%22type%3AUsed%22%5D%2C%5B%22wholesale_units%3Atrue%22%5D%5D&facets=%5B%22Location%22%2C%22algolia_sort_order%22%2C%22api_id%22%2C%22bedtype%22%2C%22body%22%2C%22certified%22%2C%22charity_vehicles%22%2C%22city_mpg%22%2C%22cylinders%22%2C%22date_in_stock%22%2C%22date_modified%22%2C%22days_in_stock%22%2C%22demo_vehicles%22%2C%22doors%22%2C%22drivetrain%22%2C%22engine_description%22%2C%22ext_color%22%2C%22ext_color_generic%22%2C%22ext_options%22%2C%22features%22%2C%22features%22%2C%22finance_details%22%2C%22ford_SpecialVehicle%22%2C%22fuel_efficient_sort%22%2C%22fueltype%22%2C%22hash%22%2C%22hw_mpg%22%2C%22in_transit_filter%22%2C%22int_color%22%2C%22int_options%22%2C%22lease_details%22%2C%22lightning%22%2C%22lightning.class%22%2C%22lightning.finance_monthly_payment%22%2C%22lightning.isPolice%22%2C%22lightning.isSpecial%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.locations%22%2C%22lightning.locations.meta_location%22%2C%22lightning.status%22%2C%22link%22%2C%22location%22%2C%22make%22%2C%22metal_flags%22%2C%22miles%22%2C%22model%22%2C%22model_number%22%2C%22msrp%22%2C%22objectID%22%2C%22our_price%22%2C%22our_price_label%22%2C%22special_field_1%22%2C%22stock%22%2C%22thumbnail%22%2C%22title_vrp%22%2C%22transmission_description%22%2C%22trim%22%2C%22type%22%2C%22vehicle_status_filter%22%2C%22vin%22%2C%22wholesale_units%22%2C%22year%22%5D&hitsPerPage=20&maxValuesPerFacet=250&page={page_num}"
# 				}, {
# 					"indexName": "frankletahonda-winback0122_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22type%3ACertified%20Used%22%2C%22type%3AUsed%22%5D%2C%5B%22wholesale_units%3Atrue%22%5D%5D&facets=Location&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				}, {
# 					"indexName": "frankletahonda-winback0122_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22Location%3AO'Fallon%22%5D%2C%5B%22wholesale_units%3Atrue%22%5D%5D&facets=type&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				}, {
# 					"indexName": "frankletahonda-winback0122_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22Location%3AO'Fallon%22%5D%2C%5B%22type%3ACertified%20Used%22%2C%22type%3AUsed%22%5D%5D&facets=wholesale_units&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				} ] })
# 
# 		else:
# 			payload = json.dumps({
...
# 				{
# 					"indexName": "frankletahonda-winback0122_production_inventory_specials_oem_price",
# 					"params": f"facetFilters=%5B%5B%22Location%3AO'Fallon%22%5D%2C%5B%22make%3AHonda%22%5D%2C%5B%22type%3ANew%22%5D%5D&facets=%5B%22Location%22%2C%22algolia_sort_order%22%2C%22api_id%22%2C%22bedtype%22%2C%22body%22%2C%22certified%22%2C%22charity_vehicles%22%2C%22city_mpg%22%2C%22cylinders%22%2C%22date_in_stock%22%2C%22date_modified%22%2C%22days_in_stock%22%2C%22demo_vehicles%22%2C%22doors%22%2C%22drivetrain%22%2C%22engine_description%22%2C%22ext_color%22%2C%22ext_color_generic%22%2C%22ext_options%22%2C%22features%22%2C%22features%22%2C%22finance_details%22%2C%22ford_SpecialVehicle%22%2C%22fuel_efficient_sort%22%2C%22fueltype%22%2C%22hash%22%2C%22hw_mpg%22%2C%22in_transit_filter%22%2C%22int_color%22%2C%22int_options%22%2C%22lease_details%22%2C%22lightning%22%2C%22lightning.class%22%2C%22lightning.finance_monthly_payment%22%2C%22lightning.isPolice%22%2C%22lightning.isSpecial%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.locations%22%2C%22lightning.locations.meta_location%22%2C%22lightning.status%22%2C%22link%22%2C%22location%22%2C%22make%22%2C%22metal_flags%22%2C%22miles%22%2C%22model%22%2C%22model_number%22%2C%22msrp%22%2C%22objectID%22%2C%22our_price%22%2C%22our_price_label%22%2C%22special_field_1%22%2C%22stock%22%2C%22thumbnail%22%2C%22title_vrp%22%2C%22transmission_description%22%2C%22trim%22%2C%22type%22%2C%22vehicle_status_filter%22%2C%22vin%22%2C%22wholesale_units%22%2C%22year%22%5D&hitsPerPage=20&maxValuesPerFacet=250&page={page_num}"
# 				}, {
# 					"indexName": "frankletahonda-winback0122_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22make%3AHonda%22%5D%2C%5B%22type%3ANew%22%5D%5D&facets=Location&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				}, {
# 					"indexName": "frankletahonda-winback0122_production_inventory_specials_oem_price",
# 					"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22Location%3AO'Fallon%22%5D%2C%5B%22type%3ANew%22%5D%5D&facets=make&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 				}, {
# 				"indexName": "frankletahonda-winback0122_production_inventory_specials_oem_price",
# 				"params": "analytics=false&clickAnalytics=false&facetFilters=%5B%5B%22Location%3AO'Fallon%22%5D%2C%5B%22make%3AHonda%22%5D%5D&facets=type&hitsPerPage=0&maxValuesPerFacet=250&page=0"
# 			} ] })
# 
# 		headers = {
...
# 
# 			
# 	def start_scraping_frankletahonda(self):
# 
