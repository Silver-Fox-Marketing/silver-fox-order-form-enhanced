#!/usr/bin/env python3
"""
Davesinclairlincolnsouth Original Scraper
=============================================
...
class DavesinclairlincolnsouthOriginalScraper:
    """Original scraper for Davesinclairlincolnsouth"""
    
    def __init__(self):
        self.base_url = "https://davesinclairlincolnsouth.com"
        self.dealer_name = "Davesinclairlincolnsouth"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}davesinclairlincolnsouth_vehicles.json"
...
def test_scraper():
    ...
    scraper = DavesinclairlincolnsouthOriginalScraper()
...
# 
# 			
# 	def start_scraping_davesinclairlincolnsouth(self):
# 
...
# 
# 		soup = self.helper.make_soup_url('https://www.davesinclairlincolnsouth.com/searchall.aspx?pt=1')
