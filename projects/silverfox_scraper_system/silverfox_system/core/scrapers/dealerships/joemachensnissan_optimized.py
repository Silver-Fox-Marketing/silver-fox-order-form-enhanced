#!/usr/bin/env python3
"""
Joemachensnissan Optimized Scraper
===================================
...
class JoeMachensNissanOptimizedScraper:
    """Production-optimized scraper for Joe Machens Nissan"""
    
    def __init__(self):
        self.base_url = "https://www.joemachensnissan.com"
        self.dealer_name = "Joemachensnissan"
    ...
    def _process_api_vehicle(self, hit: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            return {
                ...
                'make': self._clean_text(hit.get('make', 'Nissan')),
...
def test_scraper():
    ...
    scraper = JoeMachensNissanOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Joemachensnissan")
    return vehicles
