...
class MiniofstlouisWorkingScraper:
    """Scraper for MINI of St. Louis"""
    
    def __init__(self):
        self.base_url = "https://www.miniofstlouis.com"
        self.dealer_name = "MINI of St. Louis"
...
def test_scraper():
    ...
    scraper = MiniofstlouisWorkingScraper()
