#!/usr/bin/env python3
"""
Suntruphyundaisouth Optimized Scraper
===================================
...
class SuntrupHyundaiSouthOptimizedScraper:
    """Production-optimized scraper for Suntrup Hyundai South"""
    
    def __init__(self):
        self.base_url = "https://www.suntruphyundaisouth.com"
...
def test_scraper():
    ...
    scraper = SuntrupHyundaiSouthOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Suntruphyundaisouth")
    return vehicles
