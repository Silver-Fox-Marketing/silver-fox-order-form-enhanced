#!/usr/bin/env python3
"""
Joemachensnissan Original Scraper
=============================================
...
class JoemachensnissanOriginalScraper:
    """Original scraper for Joemachensnissan"""
    
    def __init__(self):
        self.base_url = "https://joemachensnissan.com"
        self.dealer_name = "Joemachensnissan"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}joemachensnissan_vehicles.json"
...
def test_scraper():
    ...
    scraper = JoemachensnissanOriginalScraper()
