#!/usr/bin/env python3
"""
Joe Machens Chrysler Dodge Jeep Ram Scraper
===========================================
...
class JoemachenscdjrWorkingScraper:
    """Scraper for Joe Machens Chrysler Dodge Jeep Ram"""
    
    def __init__(self):
        self.base_url = "https://www.joemachenscdjr.com"
        self.dealer_name = "Joe Machens Chrysler Dodge Jeep Ram"
        ...
        while True:
            try:
                ...
                payload = {
                    ...
                    "page": page,
                    "facetFilters": ["searchable_dealer_name:Joe Machens Chrysler Dodge Jeep Ram"]
                }
...
def test_scraper():
    ...
    scraper = JoemachenscdjrWorkingScraper()
