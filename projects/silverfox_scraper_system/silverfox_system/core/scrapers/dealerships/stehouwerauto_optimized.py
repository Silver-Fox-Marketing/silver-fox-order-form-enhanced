#!/usr/bin/env python3
"""
Stehouwerauto Optimized Scraper
===================================
...
class StehouwerAutoOptimizedScraper:
    """Production-optimized scraper for Stehouwer Auto"""
    
    def __init__(self):
        self.base_url = "https://www.stehouwerauto.com"
        self.dealer_name = "Stehouwerauto"
...
def test_scraper():
    ...
    scraper = StehouwerAutoOptimizedScraper()
    vehicles = scraper.get_all_vehicles()
    print(f"Found {len(vehicles)} vehicles for Stehouwerauto")
    return vehicles
