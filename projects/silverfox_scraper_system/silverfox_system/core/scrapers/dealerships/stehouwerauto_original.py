#!/usr/bin/env python3
"""
Stehouwerauto Original Scraper
=============================================
...
class StehouwerautoOriginalScraper:
    """Original scraper for Stehouwerauto"""
    
    def __init__(self):
        self.base_url = "https://stehouwerauto.com"
        self.dealer_name = "Stehouwerauto"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}stehouwerauto_vehicles.json"
...
def test_scraper():
    ...
    scraper = StehouwerautoOriginalScraper()
