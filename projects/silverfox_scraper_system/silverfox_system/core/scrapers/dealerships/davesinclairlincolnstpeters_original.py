#!/usr/bin/env python3
"""
Davesinclairlincolnstpeters Original Scraper
=============================================
...
class DavesinclairlincolnstpetersOriginalScraper:
    """Original scraper for Davesinclairlincolnstpeters"""
    
    def __init__(self):
        self.base_url = "https://davesinclairlincolnstpeters.com"
        self.dealer_name = "Davesinclairlincolnstpeters"
        self.logger = logging.getLogger(__name__)
        
        # Original scraper compatibility
        self.data_folder = "output_data/"
        self.output_file = f"{self.data_folder}davesinclairlincolnstpeters_vehicles.json"
...
def test_scraper():
    ...
    scraper = DavesinclairlincolnstpetersOriginalScraper()
